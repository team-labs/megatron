...
def minimal_megatron_setup():
    megatron_user = models.MegatronUser.objects.create(
        ...
        command_url="www.fakecommandurl.com"
    )
...
def no_bot_connections(monkeypatch):
    ...
    monkeypatch.setattr(bot_types.BotType, 'get_bot_connection',
                        fake_get_bot_connection)
    monkeypatch.setattr(bot_types.BotType, 'get_bot_connection_from_platform_id',
                        fake_get_bot_connection)
    monkeypatch.setattr(services.IntegrationService, 'get_connection',
                        fake_get_bot_connection)
    monkeypatch.setattr(services.WorkspaceService, 'get_connection',
                        fake_get_bot_connection)
